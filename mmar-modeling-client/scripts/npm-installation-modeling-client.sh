...
# wait for package.json to be created in the mmar-modeling-client directory
while [ ! -f /usr/src/app/shared/mmar/mmar-modeling-client/package.json ]; do
    echo "Waiting for package.json to be created in /usr/src/app/shared/mmar/mmar-modeling-client..."
    sleep 5
done
...
echo "----------------------------------------"
cp /usr/src/app/mmar-config-files/.env-mmar-modeling-client-development /usr/src/app/shared/mmar/mmar-modeling-client/.env.development
cp /usr/src/app/mmar-config-files/.env-mmar-modeling-client-prod /usr/src/app/shared/mmar/mmar-modeling-client/.env
